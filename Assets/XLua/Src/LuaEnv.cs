...
namespace XLua
{
    ...
    public class LuaEnv : IDisposable
    {
        ...
        public int LuacExport(string content)
        {
            return LuaAPI.luacrt_export(L, content);
        }

        public IntPtr LuacGetBytes()
        {
            return LuaAPI.luacrt_byte();
        }

        public void LuacClear()
        {
            LuaAPI.luacrt_clear();
        }
        ...
        public virtual void Dispose(bool dispose)
        {
            ...
            lock (luaEnvLock)
            {
                ...
                if (!translator.AllDelegateBridgeReleased())
                {
                    ...
                    UnityEngine.Debug.LogError("try to dispose a LuaEnv with C# callback!");
                    UnityEngine.Debug.LogError(GetDelegateBridgeTraceback());
                }
        ...
        {
            return translator.GetDelegateBridgeTraceback();
        }
